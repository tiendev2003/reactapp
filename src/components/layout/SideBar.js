...
export default function SideBar(props) {
  ...
  const displayCategoryForm = useSelector(
    (state) => state.category.displayCategoryForm
  );
  const displayTransactionForm = useSelector(
    (state) => state.transaction.displayTransactionForm
  );
  const displayAccountForm = useSelector(
    (state) => state.account.displayAccountForm
  );
  const displayBudgetForm = useSelector(
            ...
            {props.isMobile ? (
              <Box style={{ padding: 10 }}>
                ...
                <div style={{ display: "flex", justifyContent: "center" }}>
                  <Button
                    style={{ height: rem(58), marginBottom: 20 }}
                    radius={"md"}
                    variant={"subtle"}
                  >
                    <Grid>
                ...
                <NavLink
                  ...
                  icon={
                    props.currentPage === "Dashboard" ? (
                      <DashboardIconBlue style={{ width: 22, height: 22 }} />
                    ) : (
                      <DashboardIcon style={{ width: 22, height: 22 }} />
                    )
                  }
                  rightSection={<></>}
                ...
                <NavLink
                  style={{ borderRadius: 8, marginBottom: 10 }}
                  label={
                    props.currentPage === "Transactions" ? (
                      <Text size={"lg"} fw={600}>
                        Transactions
                      </Text>
                    ) : (
                  ...
                  icon={
                    props.currentPage === "Transactions" ? (
                      <TransactionsIconBlue style={{ width: 22, height: 22 }} />
                    ) : (
                      <TransactionsIcon style={{ width: 22, height: 22 }} />
                    )
                  }
                  rightSection={<></>}
                ...
                <NavLink
                  ...
                  icon={
                    props.currentPage === "Accounts" ? (
                      <AccountsIconBlue style={{ width: 22, height: 22 }} />
                    ) : (
                      <AccountsIcon style={{ width: 22, height: 22 }} />
                    )
                  }
                  rightSection={<></>}
                ...
                <NavLink
                  style={{ borderRadius: 8, marginBottom: 10 }}
                  label={
                    props.currentPage === "Budgets" ? (
                      <Text size={"lg"} fw={600}>
                        Budgets
                      </Text>
                    ) : (
                      <Text size={"lg"}>Budgets</Text>
                    )
                  }
                  icon={
                    props.currentPage === "Budgets" ? (
                      <BudgetIconBlue style={{ width: 22, height: 22 }} />
                    ) : (
                      <BudgetIcon style={{ width: 22, height: 22 }} />
                    )
                  }
                  rightSection={<></>}
                ...
                <NavLink
                  ...
                  label={
                    props.currentPage === "Goals" ? (
                      ...
                      <Text size={"lg"}>Goals</Text>
                    )
                  }
                  icon={
                    props.currentPage === "Goals" ? (
                      <GoalsIconBlue style={{ width: 22, height: 22 }} />
                    ) : (
                      <GoalsIcon style={{ width: 22, height: 22 }} />
                    )
                  }
                  rightSection={<></>}
                ...
                <NavLink
                  style={{ borderRadius: 8, marginBottom: 10 }}
                  label={
                    props.currentPage === "Debts" ? (
                      <Text size={"lg"} fw={600}>
                        Debts
                      </Text>
                    ) : (
                      <Text size={"lg"}>Debts</Text>
                    )
                  }
                  icon={
                    props.currentPage === "Debts" ? (
                      <DebtsIconBlue style={{ width: 22, height: 22 }} />
                    ) : (
                      <DebtsIcon style={{ width: 22, height: 22 }} />
                    )
                  }
                  rightSection={<></>}
                ...
                <NavLink
                  style={{ borderRadius: 8, marginBottom: 10 }}
                  label={
                    props.currentPage === "Reports" ? (
                      <Text size={"lg"} fw={600}>
                        Reports
                      </Text>
                    ) : (
                      <Text size={"lg"}>Reports</Text>
                    )
                  }
                  icon={
                    props.currentPage === "Reports" ? (
                      <ReportsIconBlue style={{ width: 22, height: 22 }} />
                    ) : (
                      <ReportsIcon style={{ width: 22, height: 22 }} />
                    )
                  }
              ...
              <Box>
                <NavLink
                  ...
                  icon={
                    props.currentPage === "Dashboard" ? (
                      <DashboardIconBlue style={{ width: 16, height: 16 }} />
                    ) : (
                      <DashboardIcon style={{ width: 16, height: 16 }} />
                    )
                  }
                  rightSection={<></>}
                  onClick={() => navigate("/dashboard")}
                ...
                <NavLink
                  ...
                  icon={
                    props.currentPage === "Transactions" ? (
                      <TransactionsIconBlue style={{ width: 16, height: 16 }} />
                    ) : (
                      <TransactionsIcon style={{ width: 16, height: 16 }} />
                    )
                  }
                  rightSection={<></>}
                  onClick={() => navigate("/transaction")}
                ...
                <NavLink
                  ...
                  icon={
                    props.currentPage === "Accounts" ? (
                      <AccountsIconBlue style={{ width: 16, height: 16 }} />
                    ) : (
                      <AccountsIcon style={{ width: 16, height: 16 }} />
                    )
                  }
                  rightSection={<></>}
                  onClick={() => navigate("/account")}
                ...
                <NavLink
                  ...
                  icon={
                    props.currentPage === "Budgets" ? (
                      <BudgetIconBlue style={{ width: 16, height: 16 }} />
                    ) : (
                      <BudgetIcon style={{ width: 16, height: 16 }} />
                    )
                  }
                  rightSection={<></>}
                  onClick={() => navigate("/budget")}
                ...
                <NavLink
                  ...
                  icon={
                    props.currentPage === "Goals" ? (
                      <GoalsIconBlue style={{ width: 16, height: 16 }} />
                    ) : (
                      <GoalsIcon style={{ width: 16, height: 16 }} />
                    )
                  }
                  rightSection={<></>}
                  onClick={() => navigate("/goal")}
                ...
                <NavLink
                  ...
                  icon={
                    props.currentPage === "Debts" ? (
                      <DebtsIconBlue style={{ width: 16, height: 16 }} />
                    ) : (
                      <DebtsIcon style={{ width: 16, height: 16 }} />
                    )
                  }
                  rightSection={<></>}
                  onClick={() => navigate("/debts")}
                ...
                <NavLink
                  ...
                  icon={
                    props.currentPage === "Reports" ? (
                      <ReportsIconBlue style={{ width: 16, height: 16 }} />
                    ) : (
                      <ReportsIcon style={{ width: 16, height: 16 }} />
                    )
                  }
                  onClick={() => navigate("/report")}
                  rightSection={<></>}
            ...
            >
              ...
              <Menu.Dropdown>
                ...
                <Menu.Item
                  ...
                  onClick={() => dispatch(showAccountForm())}
                >
                  Add Account
                </Menu.Item>
                <Menu.Item
                  icon={
                    <AddTransactionIcon style={{ height: 20, width: 20 }} />
                  }
                  transitionProps={{
                    transition: "rotate-right",
                    duration: 150,
                ...
                <Menu.Item
                  ...
                  onClick={() => dispatch(showBudgetForm())}
                >
                  Add Budget
                </Menu.Item>
                <Menu.Item
